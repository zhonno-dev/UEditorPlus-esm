...
class cls_uiDialog extends cls_UIBase {
	/**
	 * 构造函数
	 */
	constructor(options) {
...
cls_uiDialog.prototype.draggable = false;
cls_uiDialog.prototype.uiName = "dialog";
cls_uiDialog.prototype.initDialog = function () {
	var me = this,
...
cls_uiDialog.prototype.initResizeEvent = function () {
	var me = this;
...
cls_uiDialog.prototype.fitSize = function () {
...
cls_uiDialog.prototype.safeSetOffset = function (offset) {
	var me = this;
	var el = me.getDom();
...
cls_uiDialog.prototype.showAtCenter = function () {
	var vpRect = uiUtils.getViewportRect();
...
cls_uiDialog.prototype.getContentHtml = function () {
	var contentHtml = "";
...
cls_uiDialog.prototype.getHtmlTpl = function () {
	var footHtml = "";
...
cls_uiDialog.prototype.postRender = function () {
...
cls_uiDialog.prototype.mesureSize = function () {
...
cls_uiDialog.prototype._onTitlebarMouseDown = function (evt, el) {
	if (this.draggable) {
		var rect;
		var vpRect = uiUtils.getViewportRect();
		var me = this;
...
cls_uiDialog.prototype.reset = function () {
	this.getDom("content").innerHTML = this.getContentHtml();
	this.fireEvent("dialogafterreset");
};
cls_uiDialog.prototype._show = function () {
	if (this._hidden) {
		this.getDom().style.display = "";
...
cls_uiDialog.prototype.isHidden = function () {
	return this._hidden;
};
cls_uiDialog.prototype._hide = function () {
	if (!this._hidden) {
...
cls_uiDialog.prototype.open = function () {
	if (this.autoReset) {
		//有可能还没有渲染
		try {
			this.reset();
...
cls_uiDialog.prototype._onCloseButtonClick = function (evt, el) {
	this.close(false);
};
cls_uiDialog.prototype.close = function (ok) {
...
// utils.inherits(Dialog, UIBase);[X]

export default cls_uiDialog;