...
class cls_uiAutoTypeSetButton extends cls_uiSplitButton {
	/**
	 * 构造函数
	 */
	constructor(options) {
...
cls_uiAutoTypeSetButton.prototype.initAutoTypeSetButton = function () {
	var me = this;
	...
	// this.initSplitButton(); //zhu:已在 super() 时执行过一次了，不能重复执行
};

// utils.inherits(AutoTypeSetButton, SplitButton);[X]
export default cls_uiAutoTypeSetButton;