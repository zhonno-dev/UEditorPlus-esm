...
UE.commands["insertimage"] = {
    execCommand: function (cmd, opt) {
		...
		//zhu:here:
		//zhu:搜索定位： var floatStyle = first['floatStyle'];
		//zhu:这里是修改已插入的图片
		...
		domUtils.setAttributes(img, first);
		    //zhu:这里要单独再次设置 style，否则无法清除已设置的width/height
		    //	因为上方所调用的 domUtils.setAttributes() 对于 style属性的处理有问题：只会追加新内容，不会删掉已存在的内容。
		    img.style.cssText = first.style;
