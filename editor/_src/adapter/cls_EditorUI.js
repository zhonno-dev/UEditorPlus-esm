...
class cls_EditorUI extends cls_UIBase{
	...
	initEditorUI() {
		...
		editor.addListener("mousedown", function (t, evt) {
			...
			UE_ui_Popup.postHide(evt, el);
			UE_ui_ShortCutMenu.postHide(evt);
		});
		...
		editor.addListener("afterpaste", function () {
			...
			if (UE_ui_PastePicker) {
				pastePop = new UE_ui_Popup({
					content: new UE_ui_PastePicker({ editor: editor }),
					editor: editor,
		...
		var popup = new UE_ui_Popup({
			...
			queryAutoHide: function (el) {
				...
				return UE_ui_Popup.prototype.queryAutoHide.call(this, el);
			}
		});
		popup.render();
